...
def Times():  # Organiza os times que receberão os placares do apostador
    with open(
        r"C:\Users\luisg\OneDrive\Área de Trabalho\ufpa\2023.4\Prog1\Site de apostas\Times.txt",
        "r",
        encoding="utf-8",
    ) as f:
...
def times():  # Função que organiza os placares que serão sorteados
    with open(
        r"C:\Users\luisg\OneDrive\Área de Trabalho\ufpa\2023.4\Prog1\Site de apostas\resultados_random.txt",
        "r",
        encoding="utf-8",
    ) as f:
        data = [linha.split(",") for linha in f]
